module.exports = function(grunt) {
    ...
    grunt.registerTask('build', ['clean:build', 'copy:build', 'html2js', 'less:build', 'index:build']);
    grunt.registerTask('dist',  ['clean:dist',  'copy:dist',  'concat',
                                                'ngAnnotate', 'uglify',  'less:dist',  'index:dist',
                                                'karma:unit:run'
                                ]
    );
